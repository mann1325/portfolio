...
export const projects = [
  ...
  },
  {
    ...
    description: 'A full-stack banking management system built with Python and Django. Features secure user authentication, account management, transaction history, and real-time notifications. Built to provide a seamless experience for users and secure transactions.',
    image: null,
